...
import com.liuguilin.latenight.interfaces.OnInitSelectedPosition;
import com.liuguilin.latenight.interfaces.OnTagClickListener;
...
public class FlowTagLayout extends ViewGroup{
     ...
     */
    public static final int FLOW_TAG_CHECKED_NONE = 0;//只点击不选择
    /**
     * FlowLayout support single-select
     */
    public static final int FLOW_TAG_CHECKED_SINGLE = 1;//单选
    /**
     * FlowLayout support multi-select
     */
    public static final int FLOW_TAG_CHECKED_MULTI = 2;//多选
