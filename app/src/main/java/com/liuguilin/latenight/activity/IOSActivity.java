...
public class IOSActivity extends AppCompatActivity {
    ...
    private void initView() {
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(IOSActivity.this, WebViewActivity.class);
    ...
    private void getAndroid() {
        String GANK_SEARCH_ANDROID = "http://gank.io/api/search/query/listview/category/iOS/count/50/page/" + count;
