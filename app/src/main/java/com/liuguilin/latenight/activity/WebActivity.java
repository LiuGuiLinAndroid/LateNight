...
public class WebActivity extends AppCompatActivity{
    ...
    private void initView() {
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(WebActivity.this, WebViewActivity.class);
        ...
        mListView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                TastyToast.makeText(WebActivity.this, "链接已经复制到剪贴板", TastyToast.LENGTH_LONG,
                        TastyToast.SUCCESS);
                return false;
            }
        });
    ...
    private void getAndroid() {
        String GANK_SEARCH_ANDROID = "http://gank.io/api/search/query/listview/category/前端/count/50/page/" + count;
